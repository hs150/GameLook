...
// previous one is changed into new one
...
const BentoCard = ({ src, title, description }) => {
  return (
    <div className="relative size-full overflow-hidden rounded-md">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50 md:p-7">
        <div>
          <h1 className="bento-title special-font">{title}</h1>
      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="px-5 py-32">
          ...
          <p className="mt-5 max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            ...
            where each title offers unique experiences and challenges. Our
            platform is designed to bring together a diverse range of games,
            from action-packed adventures to strategic puzzles, ensuring that
            there's something for every type of gamer. Join our community and
            explore the endless possibilities that await in the world of
            MetaGames.
          </p>
        </div>
        ...
        >
          ...
          <BentoTilt
            ...
            "
          >
            <div className="flex size-full flex-col justify-between overflow-hidden rounded-md bg-violet-300 p-8 md:p-12 lg:p-15">
              <h1 className="bento-title special-font max-w-64 text-black">
                Mor<b>e</b> C<b>o</b>mi<b>n</b>g <b>s</b>o<b>o</b>n!
              </h1>
